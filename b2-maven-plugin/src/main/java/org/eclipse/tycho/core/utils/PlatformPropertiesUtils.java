 ...
 * 
 * Contributors: Andrew Niefer - IBM Corporation - initial API and implementation Sonatype Inc. - ongoing development
 *******************************************************************************/
...
public class PlatformPropertiesUtils
{
   ...
   /**
    * Constant string (value "win32") indicating the platform is running on a Window 32-bit operating system (e.g.,
    * Windows 98, NT, 2000).
    */
   ...
   /**
    * Constant string (value "unknown") indicating the platform is running on a machine running an unknown operating
    * system.
    */
   public static final String OS_UNKNOWN = "unknown";//$NON-NLS-1$

   /**
    * Constant string (value "win32") indicating the platform is running on a machine using the Windows windowing
    * system.
    */
   public static final String WS_WIN32 = "win32";//$NON-NLS-1$

   /**
    * Constant string (value "wpf") indicating the platform is running on a machine using the Windows Presendation
    * Foundation system.
    */
   ...
   /**
    * Constant string (value "photon") indicating the platform is running on a machine using the Photon windowing
    * system.
    */
   public static final String WS_PHOTON = "photon";//$NON-NLS-1$

   /**
    * Constant string (value "carbon") indicating the platform is running on a machine using the Carbon windowing system
    * (Mac OS X).
    */
   public static final String WS_CARBON = "carbon";//$NON-NLS-1$

   /**
    * Constant string (value "cocoa") indicating the platform is running on a machine using the Carbon windowing system
    * (Mac OS X).
    */
   public static final String WS_COCOA = "cocoa";//$NON-NLS-1$

   /**
    * Constant string (value "unknown") indicating the platform is running on a machine running an unknown windowing
    * system.
    */
