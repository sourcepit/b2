...
public class VersionRange
{
    ...
    * @return the <code>VersionRange</code> that is a restriction of this version range and the specified version range.
    *         <p>
    *         The restrictions of the returned version range will be an intersection of the restrictions of this version
    *         range and the specified version range if both version ranges have restrictions. Otherwise, the
    ...
    *         range, provided that ranges falls within the intersected restrictions. If the restrictions are empty, this
    *         version range's recommended version is used if it is not <code>null</code>. If it is <code>null</code>,
    *         the specified version range's recommended version is used (provided it is non-<code>null</code>). If no
