 ...
 * <ul>
 * <li>{@link org.sourcepit.b2.model.module.AbstractModule#getParent <em>Parent</em>}</li>
...
public interface AbstractModule extends FileContainer, Annotatable, Identifiable
{
    ...
    * @see org.sourcepit.b2.model.module.ModuleModelPackage#getAbstractModule_Parent()
    ...
    * {@link org.sourcepit.b2.model.module.AbstractFacet}. It is bidirectional and its opposite is '
