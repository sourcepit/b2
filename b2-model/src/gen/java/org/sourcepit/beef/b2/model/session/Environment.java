 ...
 * <ul>
 * <li>{@link org.sourcepit.beef.b2.model.session.Environment#getOs <em>Os</em>}</li>
 * <li>{@link org.sourcepit.beef.b2.model.session.Environment#getWs <em>Ws</em>}</li>
 * <li>{@link org.sourcepit.beef.b2.model.session.Environment#getArch <em>Arch</em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.sourcepit.beef.b2.model.session.SessionModelPackage#getEnvironment()
 * @model
 * @generated
 */
public interface Environment extends EObject
{
    ...
    * @see #setOs(String)
    * @see org.sourcepit.beef.b2.model.session.SessionModelPackage#getEnvironment_Os()
    * @model
    * @generated
    */
   String getOs();
   ...
   /**
    * Sets the value of the '{@link org.sourcepit.beef.b2.model.session.Environment#getOs <em>Os</em>}' attribute. <!--
    ...
    * @see #setWs(String)
    * @see org.sourcepit.beef.b2.model.session.SessionModelPackage#getEnvironment_Ws()
    * @model
    * @generated
    */
   String getWs();
   ...
   /**
    * Sets the value of the '{@link org.sourcepit.beef.b2.model.session.Environment#getWs <em>Ws</em>}' attribute. <!--
    * begin-user-doc --> <!-- end-user-doc -->
    * 
    ...
    * @see #setArch(String)
    * @see org.sourcepit.beef.b2.model.session.SessionModelPackage#getEnvironment_Arch()
    * @model
    * @generated
    */
   String getArch();
   ...
   /**
    * Sets the value of the '{@link org.sourcepit.beef.b2.model.session.Environment#getArch <em>Arch</em>}' attribute.
    * <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
