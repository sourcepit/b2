 ...
 * <ul>
 * <li>{@link org.sourcepit.beef.b2.model.internal.impl.FeaturesFacetImpl#getProjects <em>Projects</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class FeaturesFacetImpl extends ProjectFacetImpl<FeatureProject> implements FeaturesFacet
{
   ...
   {
      return B2ModelPackage.Literals.FEATURES_FACET;
   }
   ...
   public EList<FeatureProject> getProjects()
   {
      if (projects == null)
      {
         projects = new EObjectContainmentWithInverseEList<FeatureProject>(FeatureProject.class, this,
            B2ModelPackage.FEATURES_FACET__PROJECTS, B2ModelPackage.FEATURE_PROJECT__PARENT);
      }
      return projects;
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
   {
      switch (featureID)
      {
         case B2ModelPackage.FEATURES_FACET__PROJECTS :
