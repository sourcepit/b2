 ...
 * <ul>
 * <li>{@link org.sourcepit.beef.b2.model.internal.impl.PluginsFacetImpl#getProjects <em>Projects</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class PluginsFacetImpl extends ProjectFacetImpl<PluginProject> implements PluginsFacet
{
   ...
   {
      return B2ModelPackage.Literals.PLUGINS_FACET;
   }
   ...
   public EList<PluginProject> getProjects()
   {
      if (projects == null)
      {
         projects = new EObjectContainmentWithInverseEList<PluginProject>(PluginProject.class, this,
            B2ModelPackage.PLUGINS_FACET__PROJECTS, B2ModelPackage.PLUGIN_PROJECT__PARENT);
      }
      return projects;
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
   {
      switch (featureID)
      {
         case B2ModelPackage.PLUGINS_FACET__PROJECTS :
