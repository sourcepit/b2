 ...
 * 
 * 
 * @see org.sourcepit.beef.b2.model.session.SessionModelPackage#getModuleDependency()
 * @model
 * @generated
 */
public interface ModuleDependency extends EObject
{
    ...
    * @see org.sourcepit.beef.b2.model.session.SessionModelPackage#getModuleDependency_GroupId()
    * @model required="true"
    * @generated
    */
   String getGroupId();
   ...
   /**
    * Sets the value of the '{@link org.sourcepit.beef.b2.model.session.ModuleDependency#getGroupId <em>Group Id</em>}'
    ...
    * @see org.sourcepit.beef.b2.model.session.SessionModelPackage#getModuleDependency_ArtifactId()
    * @model required="true"
    * @generated
    */
   ...
   /**
    * Sets the value of the '{@link org.sourcepit.beef.b2.model.session.ModuleDependency#getArtifactId
    ...
    * @see org.sourcepit.beef.b2.model.session.SessionModelPackage#getModuleDependency_VersionRange()
    * @model required="true"
    * @generated
    */
   ...
   /**
    * Sets the value of the '{@link org.sourcepit.beef.b2.model.session.ModuleDependency#getVersionRange
