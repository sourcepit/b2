 ...
 * <ul>
 * <li>{@link org.sourcepit.beef.b2.model.module.internal.impl.ReferenceImpl#getId <em>Id</em>}</li>
 * <li>{@link org.sourcepit.beef.b2.model.module.internal.impl.ReferenceImpl#getVersionRange <em>Version Range</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class ReferenceImpl extends EObjectImpl implements Reference
{
   ...
   {
      return B2ModelPackage.Literals.REFERENCE;
   }
   ...
   public void setId(String newId)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, B2ModelPackage.REFERENCE__ID, oldId, id));
   }
   ...
   public void setVersionRange(String newVersionRange)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, B2ModelPackage.REFERENCE__VERSION_RANGE,
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType)
   {
      switch (featureID)
      {
         case B2ModelPackage.REFERENCE__ID :
            return getId();
         case B2ModelPackage.REFERENCE__VERSION_RANGE :
