...
public class RewritePomsForDevelopmentPhase
   ...
   public ReleaseResult execute(ReleaseDescriptor releaseDescriptor, ReleaseEnvironment releaseEnvironment,
      ...
      releaseHelper.rewriteEclipseVersions(result, releaseDescriptor, releaseEnvironment, reactorProjects, false, false);
      return result;
   }
   ...
   public ReleaseResult simulate(ReleaseDescriptor releaseDescriptor, ReleaseEnvironment releaseEnvironment,
      ...
      markModuleXmlsForCommit(mavenModuleProjects);
      releaseHelper.rewriteEclipseVersions(result, releaseDescriptor, releaseEnvironment, reactorProjects, false, true);
      return result;
   }
